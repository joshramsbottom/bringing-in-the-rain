...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "BringingInTheRain", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "BringingInTheRain";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "BringingInTheRain", null, { width: 800, height: 600 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "23",
			company: "HaxeFlixel",
			file: "BringingInTheRain",
			fps: 60,
			name: "BringingInTheRain",
